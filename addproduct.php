                    ...
                    <form method="POST" action="action.php">
                        ...
                        <div class="user-details">
                            ...
                            <div class="input-box">
                                ...
                                <input type="text" placeholder="image/name.jpg" name="pimage" required>
                            </div>

                            <div class="input-box">
                                <span class="details">Code</span>
                                <input type="text" placeholder="Enter Code" name="pcode" required>
                            </div>
                        </div>
                        <div class="button">
                        <button class="btn btn-info btn-block" name="addnow"><b>Upload</button>
                        </div>
                    </form>
                </div>
            </div>
