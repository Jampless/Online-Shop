                        ...
                        <div class="card mb-4">
                            <div class="card-body">
                                <table id="datatablesSimple">
                                    ...
                                    <a href="addproduct.php" class="btn btn-dark mb-2"><i class="fas fa-plus"></i> Add Product</a>
                                    <thead>
                                        <tr>
                                            <th>ID</th>
                                    ...
                                    <tbody>
                                        ...
                                        ?>
                                            ...
                                            <td><?= $row['id'] ?></td>
                                            <td colspan="2"><img src="<?= $row['product_image'] ?>" class="card-img" height="100" weight="100"></td>
